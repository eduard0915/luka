...
urlpatterns = [
    ...
    path('add_calc_relation_operation/<uuid:pk>/<uuid:dep_pk>/', ProductCalculateRelationOperationCreateView.as_view(), name='add_calc_relation_operation'),
    path('edit_calc_relation_operation/<uuid:pk>/', ProductCalculateRelationOperationUpdateView.as_view(), name='edit_calc_relation_operation'),
