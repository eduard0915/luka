...
urlpatterns = [
    ...
    path('analysis/processing_spectrophotometry/add/<uuid:pk>/', SamplingAnalysisProcessingSpectrophotometryCreateView.as_view(), name='sampling_analysis_spectrophotometry'),
