"""Pruebas unitarias para la generación de códigos de muestra."""
...
def create_sample(point, number=''):
    """Crea un proceso de muestreo con el punto y número de muestra especificados."""
...
class NextSampleNumberTests(TestCase):
    """Pruebas para la función next_sample_number y generación de códigos de muestra."""
    def test_secuencia_independiente_por_punto(self):
        """Verifica que la secuencia de códigos es independiente por punto de muestreo."""
    ...
    def test_fecha_explicita_para_catchup(self):
        """Verifica que next_sample_number acepta una fecha explícita para catchup de muestras."""
    ...
    def test_secuencia_continua_con_codigos_existentes(self):
        """Verifica que la secuencia continúa desde el último número existente para el mismo punto y fecha."""
        point = build_sample_point(code='PM1')
    ...
    def test_sin_grupo_ni_punto_lanza_error(self):
        """Verifica que crear un proceso sin grupo ni punto de muestreo lanza ValueError."""
    ...
    def test_codigo_largo_no_desborda_number_sample(self):
        """Verifica que un código de punto largo no desborda el campo number_sample (regresión)."""
    ...
    def test_puntos_distintos_con_el_mismo_codigo_comparten_secuencia(self):
        """Verifica que dos puntos con el mismo código comparten el contador de secuencia."""
    ...
    def test_codigo_prefijo_de_otro_no_colisiona(self):
        """Verifica que un código que es prefijo de otro no genera falsos positivos en la secuencia."""
    ...
    def test_number_sample_cubre_el_maximo_de_sample_point_code(self):
        """Verifica que el campo number_sample tiene capacidad suficiente para el código más el formato."""
