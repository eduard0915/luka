...
urlpatterns = [
    ...
    path('update-admin/<str:slug>/', UserUpdateAdminView.as_view(), name='user_update_admin'),
    path('update-user/<str:slug>/', UserUpdateView.as_view(), name='user_update_user'),
    ...
    path('training/add_update/<uuid:pk>/', TrainingCreateUpdateView.as_view(), name='create_update_training'),
