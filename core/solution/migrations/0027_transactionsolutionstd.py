# Generated by Django 5.2.8 on 2025-11-11 14:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('solution', '0026_alter_standardizationsolution_quantity_standard_and_more'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='TransactionSolutionStd',
            fields=[
                ...
                ('solution_inventory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='solution.solutionstd', verbose_name='Solución Estándar')),
