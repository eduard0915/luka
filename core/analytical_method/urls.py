...
urlpatterns = [
    ...
    path('detail/calculate/add_absorbance/<uuid:pk>/', AnalyticalMethodAbsorbanceCreateView.as_view(), name='add_absorbance'),
    path('detail/calculate/edit_absorbance/<uuid:pk>/', AnalyticalMethodAbsorbanceUpdateView.as_view(), name='edit_absorbance'),
